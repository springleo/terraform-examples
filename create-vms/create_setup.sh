...
# # CREATING VMs IN EACH SUBNET
 ...
 az vm create --resource-group $grp --name $vmName2 --image Ubuntu2204 --vnet-name $vnetName --subnet $subnetName2 --admin-username kamal --admin-password Hello@12345#
#
#
location="westus"
...
#
# # CREATING VM
az vm create --resource-group $grp --name $vmName --image Ubuntu2204 --vnet-name $vnetName --subnet $subnetName --admin-username kamal --admin-password Hello@12345# --location $location
#
